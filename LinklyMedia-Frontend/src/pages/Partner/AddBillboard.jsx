...
const Input = ({
  ...
  <div className="space-y-1">
    ...
    <input
      ...
      required={required}
      className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#507c88]/40 focus:border-[#507c88]"
    />
  </div>
);
...
const Textarea = ({
  ...
  <div className="space-y-1">
    ...
    <textarea
      ...
      required={required}
      rows={3}
      className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#507c88]/40 focus:border-[#507c88] resize-none"
    />
  </div>
);
    ...
    <div className="p-4 sm:p-6 max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-7">
        ...
        <div className="space-y-2">
          ...
          {previews.length > 0 && (
            <div className="flex gap-2 sm:gap-3 flex-wrap mt-2">
              {previews.map((src, i) => (
                <div key={i} className="relative group">
                  <img
                    src={src}
                    alt=""
                    className="w-20 h-14 sm:w-24 sm:h-16 object-cover rounded-lg border border-gray-200"
                  />
                  <button
                    type="button"
                    onClick={() => removeImage(i)}
                    className="absolute -top-1.5 -right-1.5 w-5 h-5 bg-red-500 text-white rounded-full flex items-center justify-center sm:opacity-0 sm:group-hover:opacity-100 transition"
                  >
              ...
              {images.length < MAX_IMAGES && (
                <button
                  ...
                  className="w-20 h-14 sm:w-24 sm:h-16 border-2 border-dashed border-gray-200 rounded-lg flex items-center justify-center text-gray-300 hover:border-[#507c88] hover:text-[#507c88] transition"
                >
                  <ImageIcon size={20} />
                </button>
              )}
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate("/partner/billboards")}
            className="w-full sm:w-auto px-5 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-500 hover:bg-gray-50 transition"
          >
            Cancel
          </button>
          <button
            type="submit"
            disabled={submitting}
            className="w-full sm:w-auto px-6 py-2.5 bg-[#507c88] text-white rounded-lg text-sm font-medium hover:bg-[#3d6370] transition disabled:opacity-60"
          >
